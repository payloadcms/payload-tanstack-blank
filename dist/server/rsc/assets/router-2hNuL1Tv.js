...
import { getServerFnById } from "../index.js";
import { c as encode$1, d as formats_default, f as formatters, g as isNotFound, l as isBuffer, s as parse, u as maybeMap } from "./index.rsc-CUDYWvAm.js";
import { r as redirect, t as isRedirect } from "./redirect-CFjMuMZp.js";
import { Vt as require_jsx_runtime_react_server } from "./upsertPreferences-BTcoIMIB.js";
import { n as Outlet } from "./RouterAdapter-DYC0F1Bz.js";
...
*/
var useRouter = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'useRouter' is called on server");
}, "b23424ebe5b1", "useRouter");
//#endregion
...
*/
var useMatch = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'useMatch' is called on server");
}, "c8ccbf54906e", "useMatch");
//#endregion
...
var useNavigate = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'useNavigate' is called on server");
}, "cad3c874c98d", "useNavigate");
//#endregion
...
var Route$7 = class extends BaseRoute {
	...
	*/
	constructor(options) {
		...
		this.Link = import_react_react_server.forwardRef((props, ref) => {
			return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Link, {
				ref,
				from: this.fullPath,
				...props
			});
...
function useStore(atom, selector, compare = defaultCompare) {
	const subscribe = (0, import_react_react_server.useCallback)((handleStoreChange) => {
		if (!atom) return () => {};
		const { unsubscribe } = atom.subscribe(handleStoreChange);
		return unsubscribe;
	}, [atom]);
	const boundGetSnapshot = (0, import_react_react_server.useCallback)(() => atom?.get(), [atom]);
...
var Asset = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'Asset' is called on server");
}, "5ed23a828737", "Asset");
//#endregion
...
*/
var HeadContent = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'HeadContent' is called on server");
}, "1a972d77754c", "HeadContent");
//#endregion
...
function renderScripts(router, scripts, assetScripts) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: allScripts.map((asset, i) => /* @__PURE__ */ (0, import_react_react_server.createElement)(Asset, {
		...asset,
...
*/ function payloadApiHandlers({ getConfig }) {
	const handler = async ({ request }) => {
		const { handleAPIRoute } = await import("./handleAPIRoute.server-DPVIaTX1.js");
...
//#endregion
//#region node_modules/.pnpm/@payloadcms+tanstack-start@4.0.0-internal.fa183d3_@tanstack+react-router@1.170.16_react_0a4024b7e3e5e3c00dd5810765c19fa8/node_modules/@payloadcms/tanstack-start/dist/exports/client.js
var withPayloadRoot = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'withPayloadRoot' is called on server");
}, "378148af8304", "withPayloadRoot");
var payloadAdminIndexRoute = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'payloadAdminIndexRoute' is called on server");
}, "378148af8304", "payloadAdminIndexRoute");
var payloadAdminSplatRoute = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'payloadAdminSplatRoute' is called on server");
}, "378148af8304", "payloadAdminSplatRoute");
var payloadLayoutRoute = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'payloadLayoutRoute' is called on server");
}, "378148af8304", "payloadLayoutRoute");
var createServerFunctionClient = /* #__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'createServerFunctionClient' is called on server");
}, "378148af8304", "createServerFunctionClient");
//#endregion
...
function FrontendRoot({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("html", {
		lang: "en",
		suppressHydrationWarning: true,
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("head", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("style", {
			href: "frontend-layer-order",
			precedence: "frontend-layer-order",
			children: layerOrder
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(HeadContent, {})] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [children, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Scripts, {})] })]
	});
}
...
})(import_react_react_server.default, assetsManifest.serverResources["src/app/_payload.tsx"], void 0, "vite-rsc/importer-resources");
//#endregion
...
var Route$4 = createFileRoute("/_frontend")({ component: FrontendLayout });
function FrontendLayout() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		"data-frontend": "",
		className: "font-sans",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Outlet, {})
	});
}
//#endregion
...
var Route$1 = createFileRoute("/_payload/api/$")({ server: { handlers: payloadApiHandlers({ getConfig: async () => (await import("./payload.config-mfWLt7bk.js")).default }) } });
//#endregion
